<template>
    <div class="wrap">
      ...
      <div class="container">
        <div class="content">
         ...
         <p class="content-num">
          ...
          <button type="button" class="btn btn-primary btn-lg btn-block" @click="down=true">积分兑换商品</button>
        </div>
      </div>
      <p class="sanshi">最近30天积分记录</p>
      <div class="no_log">
        <!--<img src="../img/暂无数据 .png" />-->
      ...
      <p class="jf">最近三十天无积分记录</p>
      <p class="da">快去下单去赚取大量数据吧</p>
      </div>
    ...
    export default {
      ...
      created(){
          this.axios.get("https://elm.cangdu.org/v3/profile/explain").then((res)=>{
            ...
            console.log(this.explain.pointtextCaption);
            console.log(this.explain.pointtextContent);
          })
      }
    }
</script>
...
<style scoped>
 ...
 .description img {
  ...
  .btn{
    background: rgb(254,109,71);
    border: rgb(254,109,71);
  }
  .num{
    font-size: 2rem;
    color: #333;
